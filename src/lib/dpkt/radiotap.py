...
_TSFT_MASK            = (1 << _TSFT_SHIFT)
_FLAGS_MASK           = (1 << _FLAGS_SHIFT)
_RATE_MASK            = (1 << _RATE_SHIFT)
_CHANNEL_MASK         = (1 << _CHANNEL_SHIFT)
_FHSS_MASK            = (1 << _FHSS_SHIFT)
_ANT_SIG_MASK         = (1 << _ANT_SIG_SHIFT)
_ANT_NOISE_MASK       = (1 << _ANT_NOISE_SHIFT)
_LOCK_QUAL_MASK       = (1 << _LOCK_QUAL_SHIFT)
_TX_ATTN_MASK         = (1 << _TX_ATTN_SHIFT)
_DB_TX_ATTN_MASK      = (1 << _DB_TX_ATTN_SHIFT)
_DBM_TX_POWER_MASK    = (1 << _DBM_TX_POWER_SHIFT)
_ANTENNA_MASK         = (1 << _ANTENNA_SHIFT)
_DB_ANT_SIG_MASK      = (1 << _DB_ANT_SIG_SHIFT)
_DB_ANT_NOISE_MASK    = (1 << _DB_ANT_NOISE_SHIFT)
_RX_FLAGS_MASK        = (1 << _RX_FLAGS_SHIFT)
_CHANNELPLUS_MASK     = (1 << _CHANNELPLUS_SHIFT)
_EXT_MASK             = (1 << _EXT_SHIFT)
